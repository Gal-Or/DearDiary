...
public class Adapter_Meeting extends RecyclerView.Adapter<Adapter_Meeting.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Meeting meeting = allMeetings.getAllMeeting().get(position);
    ...
    public int getItemCount() {
        return allMeetings.getAllMeeting().size();
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (mClickListener != null) {
                        mClickListener.onItemClick(view, allMeetings.getAllMeeting().get(getAdapterPosition()));
                    }
                }
            });
        }
        ...
        Meeting getItem(int id) {
            ...
            return allMeetings.getAllMeeting().get(id);
        }
    }
}